...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        public float RotationMultiplier
        {
            get
            {
                if (false /* m_WeaponsManager.IsAiming */)
                {
        ...
        void Update()
        {
            ...
            // crouching
            if (false /* todo m_InputHandler.GetCrouchInputDown() */)
            {
        ...
        void HandleCharacterMovement()
        {
            ...
            bool isSprinting = false; /* todo m_InputHandler.GetSprintInputHeld(); */
            {
                if (isSprinting)
                {
                ...
                Vector3 worldspaceMoveInput = transform.TransformVector(new Vector3()/* todo m_InputHandler.GetMoveInput()*/);
                ...
                if (IsGrounded)
                {
                    ...
                    // jumping
                    if (IsGrounded && false /* todo m_InputHandler.GetJumpInputDown() */)
                    {
