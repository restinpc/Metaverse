...
namespace Platformer.Mechanics
{
    ...
    /// </summary>
    public class PlayerController : Kinematic
    { 
        ...
        readonly Engine.Game gameModel = Simulation.GetModel<Engine.Game>();
        ...
        protected override void ComputeVelocity()
        {
            if (jump && IsGrounded)
            {
                velocity.y = jumpTakeOffSpeed * gameModel.jumpModifier * 1.2f;
                jump = false;
            }
            else if (stopJump)
            {
            ...
            targetVelocity = move * maxSpeed * 3;
        }
